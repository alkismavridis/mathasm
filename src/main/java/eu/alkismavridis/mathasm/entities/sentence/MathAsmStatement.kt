...
open class MathAsmStatement {
    ...
    //SECTION THEOREM EDITING
    /**
     * If check is set, the following criteria are checked:
    ...
    override fun toString() : String {
        ...
        val words1:LongArray = sen1.words
        for (i in 0 until sen1.length) {
        ...
        val words2:LongArray = sen2.words
        for (i in 0 until sen2.length) {
