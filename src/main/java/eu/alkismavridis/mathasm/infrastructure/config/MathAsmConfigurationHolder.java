package eu.alkismavridis.mathasm.infrastructure.config;
...
@Configuration
@EntityScan("eu.alkismavridis.mathasm.infrastructure.db.entities")
public class MathAsmConfigurationHolder {
    ...
    public SessionFactory sessionFactory(ApplicationContext appContext) throws Exception {
        return new SessionFactory(getConfiguration(appContext), "eu.alkismavridis.mathasm.infrastructure.db.entities");
    }
