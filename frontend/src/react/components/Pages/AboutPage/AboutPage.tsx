        ...
        return (
            <div className="AboutPage_root">
                ...
                <div className="AboutPage_chapterContent">
                    ...
                    <div>Any positive number of symbols is called a sentence. For example:</div>

                    {this.renderSentence(["(", "true", "&", "false", ")", "|", "true"])}
                    <div>is a valid MathAsm sentence, assuming that every symbols on this sentence is defined.</div>
                ...
                <div className="AboutPage_chapterContent">
                    ...
                    <div>
                        ...
                        <div>More details on that will follow soon...</div>
                    </div>
                </div>
                {this.renderChapterSeparator()}
